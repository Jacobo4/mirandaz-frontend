...
export default function Home() {
    ...
    useEffect(() => {
        useFetch('https://enigmatic-escarpment-24863.herokuapp.com/https://api.bit.io/v2beta/query', {JSON.stringify({query_string: 'select * from event_center', database_name: 'MateoG404/Ingesoft'})})
    }, [searchTerm]);
...
//  }, [searchTerm]);
    ...
    const imagesDivs =  list.map((item, i) => {
        <Card key={i} imageUrl='una imagen' title={` ${list.nombre_centro}`} description={"Lorjajlkjam dolor sit amet, consectetur adipisicing elit. Architecto eos eveniet explicabo fuga placeat quidem repellat vero voluptates! Autem doloribus esse labore minus molestiae nam, nihil porro quas, quibusdam quod, reprehenderit ullam vero voluptas. Consectetur, deserunt eligendi error ipsum maiores mollitia neque perspiciatis quisquam reprehenderit sapiente similique tempore veniam vitae!"}
            actions={(
