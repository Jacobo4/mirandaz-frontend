...
export default function Home() {
    ...
    if(data){
        ...
        const imagesDivs = data.map((image, i) => (
                <Card key={image[0]} imageUrl="https://s3.amazonaws.com/cdn.wp.m4ecmx/wp-content/uploads/2019/09/09162546/imagen-vectorial-compressor.jpg" title={image[3]} description={image[4]} 
                    actions={(
