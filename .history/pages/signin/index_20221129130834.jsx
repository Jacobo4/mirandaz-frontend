...
const LoginPage = () => {
    const[user, setIsMe] = useState(false);
        ...
        function fetchData2() {
            // envolve try function in a fetch function
                ...
                const options = {
                    ...
                    body: JSON.stringify({query_string:`select * from users where username = ${data.username} and contrasena = ${data.password}` , database_name: 'MateoG404/Ingesoft'})
                };
