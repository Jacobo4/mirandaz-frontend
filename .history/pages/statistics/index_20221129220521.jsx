...
const Statistic = () => {
    ...
    const config = {
     ...
     const gradient = ctx2.createLinearGradient(0, 16, 0, 600);
     gradient.addColorStop(0, colors.purple.half);
     gradient.addColorStop(0.65, colors.purple.quarter);
     gradient.addColorStop(1, colors.purple.zero);

     var labels2 = party.map((item) => {
      return item[1];
     })
     var weight2 = party.map((item) => {
      return item[0];
     })
     const data2 = {
      labels: labels2,
    ...
    return(
      <div className="p-8 gap-4 grid place-items-center" >
         <div className="place-items-center" style={{ width:'30vw', height:'30vw'  }}>
