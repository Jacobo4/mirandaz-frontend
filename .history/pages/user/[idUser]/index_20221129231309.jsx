...
const UserProfilePage = () => {
    ...
    const imagesDivs = party.map((image, i) => (
        <Card key={image[0]} imageUrl='https://support.content.office.net/es-es/media/2c8399b3-5194-4b4a-ad9c-04405673f8c2.jpg' layout='fill' title={`Fiesta ${image[2]}`} description={image[7]}
            actions={(
                <>
    ...
    return <div className="container grid gap-8">
        <div className="rounded overflow-hidden shadow-md grid grid-flow-col gap-4 max-w-2xl m-auto p-4">
            <div className={"w-32 m-auto"}>
                {(user!= undefined) ?  <Image src='https://ph-files.imgix.net/81c8176a-1b00-4f10-b60f-2ab2729d0a14.png?auto=format' width={100} height={100}  className={"rounded-full"} alt={""}/> : <div className={"w-32 h-32 rounded-full bg-gray-300"}/>}
